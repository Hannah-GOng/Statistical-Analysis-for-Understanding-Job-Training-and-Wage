...
#### **Response variable vs change in wages**
...
```{r}
# Choose the one gonna include, comment out others
...
chi-square test for indepdence ???
...
##### **Confusion matrix: Threshold = 0.5, final model**
```{r}
...
##### **Confusion matrix: Threshold = mean-level, final model**
```{r, include=F}
